...
cd /d %~dp0
taskkill /F /im  output.exe

ld -o output.exe output.o -e_main -lkernel32 --enable-stdcall-fixup %SYSTEMROOT%\system32\kernel32.dll -luser32 --enable-stdcall-fixup %SYSTEMROOT%\system32\user32.dll
