...
public class RegSize {
	...
	public static int MEM = b32; //16
	public static int BYTE = b32; //8
	public static int INT = b32; //16
	public static int LONG = b32; //32
	...
	public static String get(int t, String v) {
		if(v.equalsIgnoreCase("byte") || v.equalsIgnoreCase("word") || v.equalsIgnoreCase("dword")) {
			...
			if(t == b8)
				...
				return "edx";
		}else if(v.equalsIgnoreCase("si") || v.equalsIgnoreCase("esi")) {
			if(t == b16)
				return "si";
			else if(t == b32)
				return "esi";
		}else if(v.equalsIgnoreCase("di") || v.equalsIgnoreCase("edi")) {
			if(t == b16)
				return "di";
			else if(t == b32)
				return "edi";
